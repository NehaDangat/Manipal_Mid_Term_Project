...
public class DoctorServiceImp implements IDoctorService {
	...
	public List<Appointment> myAppointments(long doctorId) {
		...
		long doctorId1 = doctor.getDocotrId();
		
		@SuppressWarnings("unchecked")
		List<Appointment> appointments = restTemplate.getForObject("http://localhost:2003/api/appointment/getAppointmentByDoctor/"+doctorId1,List.class);
	...
	public Schedule addMySchedule(Schedule schedule) {
		...
		Schedule schedule2 = restTemplate.postForObject("http://localhost:2007/schedule/addSchedule", schedule,Schedule.class);
